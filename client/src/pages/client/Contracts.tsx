        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-navyblue mb-2">My Contracts</h1>
                <p className="text-gray-600">
                  View and manage all your contracts with HLSG Industries.
                </p>
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center text-navyblue">
                ...
                Contract List ({filteredContracts.length})
              </CardTitle>
            </CardHeader>
            <CardContent>
              {contractsLoading ? (
